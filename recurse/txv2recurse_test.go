...
func TestInitialRecursion(t *testing.T) {
	...
	innerCcs, verifyingKey, provingKey, genesisWitness, previousProof := createBaseCaseProof(fullTxBytes, prefixBytes, prevTxnIdBytes, postFixBytes)
...
func TestSuccintRecurse(t *testing.T) {
	...
	outerAssignment := createOuterAssignment(circuitWitness, circuitProof, prefixBytes, prevTxnIdBytes, postFixBytes, fullTxBytes)
